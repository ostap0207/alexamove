...
## Concepts
This simple sample has no external dependencies or com.salemove.alexa.session management, and shows the most basic example of how to create a Lambda function for handling Alexa Skill requests.
...
8. Set the Handler as HelloWorldSpeechletRequestStreamHandler (this refers to the Lambda RequestStreamHandler file in the zip).
