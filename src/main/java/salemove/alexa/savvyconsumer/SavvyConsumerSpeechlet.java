 ...
 */
package salemove.alexa.savvyconsumer;
 ...
 * <li><b>Dialog and Session state</b>: Handles two models, both a one-shot ask and tell com.salemove.alexa.model, and
 * a multi-turn dialog com.salemove.alexa.model. If the user provides an incorrect slot in a one-shot com.salemove.alexa.model, it will
 * direct to the dialog com.salemove.alexa.model. See the examples section for sample interactions of these models.</li>
 * <li><b>SSML</b>: Using SSML tags to control how Alexa renders the text-to-speech</li>
 * </ul>
 * <p>
 * <h2>Examples</h2>
 * <p>
 * <b>Dialog com.salemove.alexa.model</b>
 * <p>
 ...
 * User : "no"
 * <p>
 * <b>One-shot com.salemove.alexa.model</b>
 * <p>
...
public class SavvyConsumerSpeechlet implements Speechlet {
    ...
    /**
     * The key to find the current index from the com.salemove.alexa.session attributes.
     */
    private static final String SESSION_CURRENT_INDEX = "current";

    /**
     * The key to find the current category from the com.salemove.alexa.session attributes.
     */
    ...
    private SpeechletResponse getTopSellers(final Intent intent, final Session session)
        ...
        // Check if we are in a com.salemove.alexa.session, and if so then reprompt for yes or no
        ...
        if (lookupCategory != null) {
            ...
            // com.salemove.alexa.session attributes for pagination.
            int i = 0;
            for (String item : items) {
                ...
                // Set the com.salemove.alexa.session attributes and full card output
            ...
            speechOutput.append(" Would you like to hear the com.salemove.alexa.rest?");
            repromptText = "Would you like to hear the com.salemove.alexa.rest? Please say yes or no.";
    ...
    /**
     * Gets the 2nd-MAX_ITEMS number of titles from the com.salemove.alexa.session attributes.
     */
    private SpeechletResponse getNextPageOfItems(final Intent intent, final Session session) {
        if (session.getAttributes().containsKey(SESSION_CURRENT_INDEX)) {
            ...
            // Iterate through the com.salemove.alexa.session attributes to create the next n results for the user.
            ...
            // Set the new index and end the com.salemove.alexa.session if the newIndex is greater than the MAX_ITEMS
