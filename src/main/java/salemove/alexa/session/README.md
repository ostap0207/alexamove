...
8. Set the Handler as SessionSpeechletRequestStreamHandler (this refers to the Lambda RequestStreamHandler file in the zip).
...
2. Set "Session" as the skill name and "com.salemove.alexa.session" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, tell com.salemove.alexa.session my color is green."
...
### One-shot com.salemove.alexa.model:
    User: "Alexa, tell com.salemove.alexa.session my color is green."
