 ...
 */
package salemove.alexa.session;
 ...
 * com.salemove.alexa.session interactions.
 */
public class SessionSpeechlet implements Speechlet {
    ...
    public SpeechletResponse onIntent(final IntentRequest request, final Session session)
        ...
        // Note: If the com.salemove.alexa.session is started with an intent, no welcome message will be rendered;
    ...
    private SpeechletResponse getColorFromSession(final Intent intent, final Session session) {
        ...
        // Get the user's favorite color from the com.salemove.alexa.session.
        String favoriteColor = (String) session.getAttribute(COLOR_KEY);

        // Check to make sure user's favorite color is set in the com.salemove.alexa.session.
